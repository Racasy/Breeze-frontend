...
<template>
    <div class="col-span-1">
        <div class="bg-white shadow overflow-hidden sm:rounded-lg h-full">
            <div class="px-4 py-2 ">
                <h3 class="flex justify-center items-center h-full">
                <!--Icon-->
                <svg width="40px" height="40px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Dribbble-Light-Preview" transform="translate(-180.000000, -2159.000000)" fill="#6b7280">
            ...
            <div class="border-t border-gray-200">
                ...
                <a href="/user-profile" class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                    Your Profile
                </a>
                <a href="/company-profile" class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                    Your Company
                </a>
                </nav>
            </div>
            <div v-if="userData.id === 4 " class="px-4 py-10 sm:px-6 flex items-center justify-between text-3xl text-red-900">Hihi tu esi admins</div>
        </div>
    </div>
</template>